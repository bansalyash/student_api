...
MONGODB_URI = "mongodb://test:test@ds155473.mlab.com:55473/student_record1"
client = MongoClient(MONGODB_URI)
db = client.get_database("student_record1")
...
def student_list():
	if request.method == 'GET':
		...
		return json_util.dumps(students), 200					#to avoid binary data i.e. the _id of every document
...
def get_student(roll_no):
	...
	if request.method == 'GET':
		...
		student_record.update_one({'roll_no':roll_no}, {'$set':request.form})			#might require checks for proper work
